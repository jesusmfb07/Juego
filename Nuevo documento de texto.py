...
class Bullet(pygame.sprite.Sprite):
	def __init__(self, x, y):
		super().__init__()
		self.image = pygame.image.load("assets/lacer.png")
		self.image.set_colorkey(BLACK)
		self.rect = self.image.get_rect()
		self.rect.y = y
		self.rect.centerx = x
...
meteor_images = []
meteor_list = ["assets/meteorGrey_big1.png", "assets/meteorGrey_big22.png", "assets/meteorGrey_big3.png", "assets/meteorGrey_big4.png",
